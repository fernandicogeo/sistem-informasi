    ...
    <section class="py-5 mt-5">
        <div class="container py-5">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6">
                    <div>
                        <form class="p-3 p-xl-4" action="/tanggapan-reviewer/{{ $evaluation->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <label for="pimpinan_name">Pimpinan :</label>
                            <input class="shadow form-control mb-3" id="pimpinan_name" name="pimpinan_name" rows="6" readonly value="{{ $evaluation['pimpinan_name'] }}">
                            <label for="pimpinan_reply">Tanggapan Pimpinan :</label>
                            <input class="shadow form-control mb-3" id="pimpinan_reply" name="pimpinan_reply" rows="6" readonly value="{{ $evaluation['pimpinan_reply'] }}">
                            <label for="reviewer_reply">Tanggapan :</label>
                            <textarea class="shadow form-control mb-3" id="reviewer_reply" name="reviewer_reply" rows="6"></textarea>
