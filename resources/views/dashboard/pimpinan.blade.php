                                    ...
                                    <tr>
                                        <td>
                                            @if ($evaluation['kps_name'] != NULL && $evaluation['pimpinan_name'] == NULL) 
                                                {{-- <a class="btn btn-warning" href="/tindak-lanjut/{{ $evaluation->id }}" role="button">Tindak Lanjut Evaluasi</a> --}}
                                                <a class="btn btn-primary" href="/tanggapan-pimpinan/{{ $evaluation->id }}" role="button">Beri Tanggapan</a>
                                            @endif
                                            ...
                                            @endif
                                            @if ($evaluation['pimpinan_name'] != NULL) 
