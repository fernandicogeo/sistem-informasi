        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 class="display-6 fw-bold mb-4">Kolom Tindak Lanjut</h2>
                </div>
            </div>
            <div class="row d-flex justify-content-center">
                <div class="col-md-6">
                    <div>
                        <form class="p-3 p-xl-4" action="/tindak-lanjut/{{ $evaluation->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <label for="kps_reply">Tindak Lanjut :</label>
                            <textarea class="shadow form-control mb-3" id="kps_reply" name="kps_reply" rows="6"></textarea>
