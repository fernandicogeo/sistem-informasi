    ...
    <section class="py-5 mt-5">
        <div class="container py-5">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6">
                    <div>
                        <form class="p-3 p-xl-4" action="/edit-evaluasi/{{ $evaluation->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <input class="shadow form-control mb-3" id="title" name="title" rows="6" value="{{ $evaluation['title'] }}">
                            <label for="content">Evaluasi :</label>
                            <textarea class="shadow form-control mb-3" id="content" name="content" rows="6">{{ $evaluation['content'] }}</textarea>
